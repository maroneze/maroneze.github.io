...
var exibirPalavraDesconhecida = function (palavra) {
  var novoLinkAdicionarDic = $('<span>').addClass('fakeLink').attr('onclick', 'adicionarPalavra("' + palavra + '")').text("Adicionar ao dicionário");
  var spanLinkAdicionarDic = $('<span>').append(novoLinkAdicionarDic);
  var novoLinkAdicionarNeo = $('<span>').addClass('fakeLink').attr('onclick', 'adicionarNeologismo("' + palavra + '")').text("Neologismo");
  var novoItem = $('<li>').append($('<span>').text(palavra));
